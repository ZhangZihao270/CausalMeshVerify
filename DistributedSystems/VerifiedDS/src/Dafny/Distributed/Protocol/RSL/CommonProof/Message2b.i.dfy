...
module CommonProof__Message2b_i {
  ...
  lemma lemma_2bMessageHasCorresponding2aMessage2(
    b:Behavior<RslState>,
    c:LConstants,
    i:int,
    p_2b:RslPacket
    ...
    requires p_2b.msg.RslMessage_2b?
    ensures |p_2a| > 0
    ensures  p_2a[0] in b[i].environment.sentPackets
    ensures  p_2a[0].src in c.config.replica_ids
    ensures  p_2a[0].msg.RslMessage_2a?
    ensures  p_2a[0].msg.opn_2a == p_2b.msg.opn_2b
    ensures  p_2a[0].msg.bal_2a == p_2b.msg.bal_2b
    ensures  p_2a[0].msg.val_2a == p_2b.msg.val_2b
    decreases i
  {
    if i == 0
    {
    ...
    if p_2b in b[i-1].environment.sentPackets
    {
      p_2a := lemma_2bMessageHasCorresponding2aMessage2(b, c, i-1, p_2b);
      lemma_PacketStaysInSentPackets(b, c, i-1, i, p_2a[0]);
      return;
    }
