...
module LiveByzRSL__ReplicaModel_i {
  ...
  method CReplicaNextProcessRequest(
    ...
    ensures Replica_Common_Postconditions(AbstractifyCReplicaToLReplica(s), s', received_packet, sequential_sent_packets)
    ...
    //     (AbstractifyCReplicaToLReplica(s)), s', received_packet, sequential_sent_packets)
  {
    ...
    lemma_Postconditions(s, received_packet, s', sequential_sent_packets);
